...
var ShaCheckOrder = function () {
    ...
    $.ajax({
        ...
        data: {"fapiao": fapiao, "cjson": cjson, "yunfei": $("#hid_yunfei").val(), "InValue": $("#hid_InValue").val(), "OtherValue": $("#hid_OtherValue").val(), "card1": $("#card_1").html(), "PcValue": $("#hid_PcValue").val(), "qgid": $("#hid_qgid").val(), "tgid": $("#hid_tgid").val(), "packid": $("#hid_packid").val(), "json": $("#hid_json").val(), "huodong": $("#Sp_huodong").html(), "discount": $("#hid_zk").val(), "product": $("#hid_p").val(), "vip": $("#hid").val(), "YouHui": $("#Sp_YouHui").html(), "Active": $("#Sp_Active").html(), "code": SN, "card": $("#card_0").html(), "Total": $("#Sp_Total").html(), "payType": payType, "DefrayManner": DefrayManner, "SysNo": SysNo, "peisongtime1": peisongtime1, "peisongtime2": peisongtime2, "peisongdate": peisongdate, "peisongtime1": peisongtime1, "beizhu": beizhu, "benzhuRong": benzhuRong, "hk_type": hk_type, "hekareiRong": hekareiRong, "hk_type": hk_type, "hekareiRong": hekareiRong, "annexarticle": annexarticle, "fp_heka": fp_heka, "dinghuo": dingHuo, "shouHuo": shouHuo, "sha": "0", "Invoice": Invoice, "fpkey": fpkey, "birthday": birthday, "buchaprice": ChaPrice, "panic": $("#panic").val() },
        success: function (data) {
            if (data.msg == "订单生成成功") {
                $(".ui_popup").hide();
                $("#coupon_ture").popupFn();
        ...
        success: function (data) {
            if (data.msg == "0") {
               // "cjson": Consignee, 
                $.ajax({
                    url: "../WebPage/AddOrder.aspx", dataType: "json", type: "post", timeout: "10000",
                    data: {"fapiao": fapiao, "cjson": Consignee, "InValue": $("#hid_InValue").val(), "OtherValue": $("#hid_OtherValue").val(), "card1": $("#card_1").html(), "PcValue": $("#hid_PcValue").val(), "qgid": $("#hid_qgid").val(), "tgid": $("#hid_tgid").val(), "packid": $("#hid_packid").val(), "json": $("#hid_json").val(), "huodong": $("#Sp_huodong").html(), "discount": $("#hid_zk").val(), "product": $("#hid_p").val(), "vip": $("#hid").val(), "YouHui": $("#Sp_YouHui").html(), "Active": $("#Sp_Active").html(), "code": SN, "card": $("#card_0").html(), "Total": $("#Sp_Total").html(), "payType": payType, "DefrayManner": DefrayManner, "SysNo": SysNo, "peisongtime2": peisongtime2, "peisongdate": peisongdate, "peisongtime1": peisongtime1, "beizhu": beizhu, "benzhuRong": benzhuRong, "hk_type": hk_type, "hekareiRong": hekareiRong, "hk_type": hk_type, "hekareiRong": hekareiRong, "annexarticle": annexarticle, "fp_heka": fp_heka, "shouHuo": shouHuo, "Invoice": Invoice, "fpkey": fpkey, "birthday": birthday, "buchaprice": ChaPrice, "panic": $("#panic").val(), "paniccake": $("#hid_paniccake").val() },
                    success: function (data) {
                        if (data.msg == "订单生成成功") {
                            $(".ui_popup").hide();
                            $("#coupon_ture").popupFn();
